(() => {
  ...
  // ns-hugo-params:/home/robert/Documents/whatllitbe/themes/hugo-theme-bootstrap/assets/js/mode/index.ts
  var mode_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", searchbar: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };

  // ns-hugo-params:/home/robert/Documents/whatllitbe/themes/hugo-theme-bootstrap/assets/js/local-storage/index.ts
  var local_storage_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", searchbar: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };

  // ns-hugo-imp:/home/robert/Documents/whatllitbe/themes/hugo-theme-bootstrap/assets/js/local-storage/index.ts
  ...
  // ns-hugo-imp:/home/robert/Documents/whatllitbe/themes/hugo-theme-bootstrap/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
  ...
  // ns-hugo-imp:/home/robert/Documents/whatllitbe/themes/hugo-theme-bootstrap/assets/js/palettes/index.ts
